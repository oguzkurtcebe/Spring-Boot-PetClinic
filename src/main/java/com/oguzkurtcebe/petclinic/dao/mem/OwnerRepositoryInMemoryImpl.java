package com.oguzkurtcebe.petclinic.dao.mem;
...
public class OwnerRepositoryInMemoryImpl implements OwnerRepository {
	...
	owner1.setLastName("Kurtcebe");
	
	Owner owner2=new Owner();
	owner2.setId(2L);
	owner2.setFirstName("Taner");
	owner2.setLastName("Kurtcebe");
	...
	owner4.setId(4L);
	owner4.setFirstName("Cagan");
	owner4.setLastName("Kurtcebe");
